...
local MobDropdown = FarmTab:CreateDropdown({
    ...
    MultiSelect = true,
    CurrentOption = {},
    Flag = "SelectedMobs",   -- helps with config saving
    Callback = function(Option)
        -- Rayfield sometimes sends string instead of table → normalize it
        local selected = {}
...
print(" • Multi-select dropdown fixed – no more callback errors")
print(" • Selected mobs shown stacked (one per line)")
